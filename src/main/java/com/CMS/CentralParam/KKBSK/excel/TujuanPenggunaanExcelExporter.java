...
public class TujuanPenggunaanExcelExporter {
    ...
    private List<DataTujuanPenggunaan> listCluster;
     
    public TujuanPenggunaanExcelExporter(List<DataTujuanPenggunaan> listCluster) {
    ...
    private void writeDataLines() {
        ...
        for (DataTujuanPenggunaan Cluster : listCluster) {
