...
public class TujuanPenggunaan {
    ...
    public TujuanPenggunaan(Integer id, String nama, Integer produk, String deskripsi, Date startBerlaku, Date endBerlaku, Integer statusApproval, String remarks, Integer isRejected, Integer isApproved, Long createdBy, Date createdDate, Long updatedBy, Date updatedDate) {
        this.id = id;
        this.nama = nama;
        this.produk = produk;
