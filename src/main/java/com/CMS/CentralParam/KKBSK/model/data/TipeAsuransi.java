...
public class TipeAsuransi {
    ...
    public TipeAsuransi(Integer id, String namaAsuransi, String deskripsi, Date startBerlaku, Date endBerlaku, Integer statusApproval, String remarks, Integer isRejected, Integer isApproved, Long createdBy, Date createdDate, Long updatedBy, Date updatedDate) {
        this.id = id;
