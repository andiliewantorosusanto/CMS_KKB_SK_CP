...
public class DataJenisPembiayaan {
    ...
    public DataJenisPembiayaan(Integer id, String nama, Integer produk, String deskripsi, Date start_date, Date end_date, Integer is_approved, Integer is_rejected, String remarks) {
        this.id = id;
        this.nama = nama;
        this.produk = produk;
    ...
    public DataJenisPembiayaan nama(String nama) {
        setNama(nama);
        return this;
    }
    ...
    public DataJenisPembiayaan deskripsi(String deskripsi) {
