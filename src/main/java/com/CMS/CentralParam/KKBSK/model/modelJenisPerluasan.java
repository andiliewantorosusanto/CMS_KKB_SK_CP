...
public class modelJenisPerluasan implements Serializable {
    ...
    public modelJenisPerluasan(Integer id, String Nama, Integer Produk, String Deskripsi, Date Start_date, Date End_date, Integer is_approved, Integer is_rejected, String remarks, Integer createdby, Date createddate, Integer updatedby, Date updateddate, Integer multiple_select) {
        this.id = id;
        this.Nama = Nama;
        this.Produk = Produk;
