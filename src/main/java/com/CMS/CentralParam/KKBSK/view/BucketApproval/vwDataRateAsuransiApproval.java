package com.CMS.CentralParam.KKBSK.view.BucketApproval;

import java.util.Date;

public class vwDataRateAsuransiApproval {
...
private Integer program;
    ...
    public vwDataRateAsuransiApproval(Integer wilayah, Integer startOTR, Integer endOTR, Integer startyear, Integer endyear, Integer tipeAsuransi, Date startBerlaku, Date endBerlaku, Integer loan_type, Integer produk, Integer jenis_kendaraan, Integer jenis_pembiayaan, String statusApproved, String remarks, Integer program) {
